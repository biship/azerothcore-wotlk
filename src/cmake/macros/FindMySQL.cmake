...
function(check_mysql_version)
  if(UNIX AND MYSQL_CONFIG) # Keep the original Unix logic
	execute_process(
	  COMMAND "${MYSQL_CONFIG}" --version
	  OUTPUT_VARIABLE MYSQL_VERSION
	  OUTPUT_STRIP_TRAILING_WHITESPACE
	)
  elseif(WIN32 AND MYSQL_EXECUTABLE) # Add new logic for Windows
	execute_process(
	  COMMAND "${MYSQL_EXECUTABLE}" --version
	  OUTPUT_VARIABLE MYSQL_VERSION_STRING
	  OUTPUT_STRIP_TRAILING_WHITESPACE
	)
	#message(STATUS "Raw ver: ${MYSQL_VERSION_STRING}")
	# Extract just the version number (e.g., from "mysql  Ver 8.4.0 for Win64...")
	string(REGEX MATCH "[0-9]+\\.[0-9]+\\.[0-9]+" MYSQL_VERSION "${MYSQL_VERSION_STRING}")
  endif()

  # This part now works for both platforms if a version was found
  if(MYSQL_VERSION)
